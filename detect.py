...
from stereo.dianyuntu_yolo import preprocess, undistortion, getRectifyTransform, draw_line, rectifyImage,\
     stereoMatchSGBM, hw3ToN3, DepthColor2Cloud
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if (x <= 1280):
                            ...
                            cv2.rectangle(im0,(int(xyxy[2]),int(xyxy[1])),(int(xyxy[2])+5+220,int(xyxy[1])+150),colors[int(cls)],-1);
                            cv2.putText(im0, text_x, (int(xyxy[2])+5, int(xyxy[1])+30),  cv2.FONT_ITALIC, 1.2, (255,255,255), 3)
                            cv2.putText(im0, text_y, (int(xyxy[2])+5, int(xyxy[1])+65),  cv2.FONT_ITALIC, 1.2, (255, 255, 255), 3)
                            cv2.putText(im0, text_z, (int(xyxy[2])+5, int(xyxy[1])+100), cv2.FONT_ITALIC, 1.2, (255, 255, 255), 3)
                            cv2.putText(im0, text_dis, (int(xyxy[2])+5, int(xyxy[1])+145), cv2.FONT_ITALIC, 1.2, (255, 255, 255), 3)

                            # cv2.rectangle(im0, (xyxy[0] + (xyxy[2] - xyxy[0]), xyxy[1]),
                            #               (xyxy[0] + (xyxy[2] - xyxy[0]) + 5 + 220, xyxy[1] + 150), colors[int(cls)],
                            #               -1);
                            # cv2.putText(im0, text_x, (xyxy[0] + (xyxy[2] - xyxy[0]) + 5, xyxy[1] + 30), cv2.FONT_ITALIC,
                            #             1.2, (255, 255, 255), 3)
                            # cv2.putText(im0, text_y, (xyxy[0] + (xyxy[2] - xyxy[0]) + 5, xyxy[1] + 65), cv2.FONT_ITALIC,
                            #             1.2, (255, 255, 255), 3)
                            # cv2.putText(im0, text_z, (xyxy[0] + (xyxy[2] - xyxy[0]) + 5, xyxy[1] + 100),
                            #             cv2.FONT_ITALIC, 1.2, (255, 255, 255), 3)
                            # cv2.putText(im0, text_dis, (xyxy[0] + (xyxy[2] - xyxy[0]) + 5, xyxy[1] + 145),
                            #             cv2.FONT_ITALIC, 1.2, (255, 255, 255), 3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='001.mp4' , help='source')  # file/folder, 0 for webcam
